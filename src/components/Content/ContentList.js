...
import { 
  action_content_list,
  action_content_list_onSelect,
  action_content_list_search,
  action_content_list_updateparams,
  action_content_list_export
} from "../../actions/content/contentListAction";
...
ContentList = Form.create()(ContentList);

const mapStateToProps = state => {
  return {
    //galleryData:state.content.contentGallery
    listData:state.content.contentList
  }
}

const mapDispatchToProps = dispatch => {
  return {
    getList:(...args) => dispatch(action_content_list(...args)),
    // (page, pageSize, titles);  
    updateparams:(...args) => dispatch(action_content_list_updateparams(...args)),
    onSelect:(...args) => dispatch(action_content_list_onSelect(...args)),
    onSearch:(...args) => dispatch(action_content_list_search(...args)),
    requestExportList:(...args) => dispatch(action_content_list_export(...args)),
