...
import {
  action_data_linkClick_list,
  action_data_linkClick_onSelect,
  action_data_linkClick_updateparams,
  action_data_linkClick_search,
  action_data_linkClick_export
} from "../../actions/data/linkClicksAction";
...
class LinkClicks extends React.Component {
  ...
  componentDidMount(){
    console.log("进入到 LinkClicks 组件",this.props);
    this.props.getList();
  }
  render(){
...
LinkClicks = Form.create()(LinkClicks);

const mapStateToProps = state => {
  return {
    //galleryData:state.content.contentGallery
    listData:state.data.linkClicks
  }
}

const mapDispatchToProps = dispatch => {
  return {
    getList:(...args) => dispatch(action_data_linkClick_list(...args)),
    // (page, pageSize, titles);
    updateparams:(...args) => dispatch(action_data_linkClick_updateparams(...args)),
    onSelect:(...args) => dispatch(action_data_linkClick_onSelect(...args)),
    onSearch:(...args) => dispatch(action_data_linkClick_search(...args)),
    requestExportList:(...args) => dispatch(action_data_linkClick_export(...args)),
