...
import {
  action_data_bannerClick_list,
  action_data_bannerClick_onSelect,
  action_data_bannerClick_search,
  action_data_bannerClick_updateparams,
  action_data_bannerClick_export
} from "../../actions/data/bannerClickAction";
...
class BannerClicks extends React.Component {
  /**
   * 分页、排序、筛选变化时触发
   * @param pagination
   * @param filters
...
BannerClicks = Form.create()(BannerClicks);

const mapStateToProps = state => {
  return {
    //galleryData:state.content.contentGallery
    listData:state.data.bannerClicks
  }
}

const mapDispatchToProps = dispatch => {
  return {
    getList:(...args) => dispatch(action_data_bannerClick_list(...args)),
    // (page, pageSize, titles);
    updateparams:(...args) => dispatch(action_data_bannerClick_updateparams(...args)),
    onSelect:(...args) => dispatch(action_data_bannerClick_onSelect(...args)),
    onSearch:(...args) => dispatch(action_data_bannerClick_search(...args)),
    requestExportList:(...args) => dispatch(action_data_bannerClick_export(...args)),
